...
import com.mycompany.fusionauth.plugins.ExampleCustomMD5SaltedAlternativePasswordEncryptor;
...
public class MyExampleFusionAuthPluginModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    passwordEncryptorMapBinder.addBinding("alt-custom-md5").to(ExampleCustomMD5SaltedAlternativePasswordEncryptor.class);
