...
public class ExampleSaltedSHA512PasswordEncryptor implements PasswordEncryptor {
  ...
  public String encrypt(String password, String salt, int factor) {
    ...
    // LDAP algorithm to generate the userPassword value: <base64 of <digest of cleartext-password salt> salt> – https://tools.ietf.org/id/draft-stroeder-hashed-userpassword-values-01.html
